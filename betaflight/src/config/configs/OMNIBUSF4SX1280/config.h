...
#define RX_EXPRESSLRS_SPI_RESET_PIN     PA9
#define RX_EXPRESSLRS_SPI_BUSY_PIN      PA10
#define RX_SPI_CS                       PD2
#define RX_SPI_EXTI                     PA0
#define RX_SPI_LED                      PB5 
//---- 
...
#define RX_SPI_LED_PIN                  PB5
#define RX_SPI_EXPRESSLRS_RESET_PIN     PA9
#define RX_SPI_EXPRESSLRS_BUSY_PIN      PA10
//----
